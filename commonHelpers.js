import{i as p,S as y}from"./assets/vendor-5b791d57.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();function f(o){return o.hits.map(({largeImageURL:t,webformatURL:r,tags:a,likes:e,views:s,comments:n,downloads:u})=>`<div class="gallery-item>
  ...
  </div>`).join("")}const d="42660444-3b11bfb6c5a092fcbbd55e52b",g="https://pixabay.com/api/",i=document.querySelector(".loader");function m(o){const t=`${g}?key=${d}&q=${o}&image_type=photo&orientation=horizontal&savesearch=true`;return i.style.display="block",fetch(t).then(r=>{if(!r.ok)throw new Error(`Response error ${r.status}`);return r.json()}).then(r=>(i.style.display="none",r.hits.length===0&&p.error({title:"Error",timeout:3e3,position:"bottomRight",message:"Sorry, there are no images matching your search query. Please try again!"}),r)).catch(r=>console.log(`Error: ${r}`))}const h=document.querySelector(".form"),c=document.querySelector(".gallery"),l=document.querySelector(".loader"),b=new y(".gallery a",{captionsData:"alt",captionDelay:250});h.addEventListener("submit",$);l.style.display="none";function $(o){o.preventDefault(),l.style.display="grid",c.innerHTML="";const t=o.currentTarget,r=t.elements.query.value.trim();if(r===""){p.show({title:"Error",color:"yellow",message:"Please search for something"}),l.style.display="none";return}m(r).then(a=>{c.innerHTML=f(a),b.refresh(),t.reset()}).catch(a=>{console.error("Error:",a)}).finally(()=>l.style.display="none")}
